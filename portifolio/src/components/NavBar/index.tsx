...
const NavBar = ({setIsOpen}:IOpenMenu) => {
    ...
    return(
        <div className="w-[290px] h-screen flex items-center justify-center text-xl">
            <div className="flex-col space-y-6">
                <div className="w-70 h-full text-slate-100 flex items-center justify-end cursor-pointer hover:text-blue-600" onClick={() => setIsOpen(false)}><AiOutlineClose size={25}/></div>
                <ul className="w-54 gap-x-36 flex-col text-slate-100 ">
                    <li className="hover:text-blue-600 cursor-pointer">Home</li>
                    <li className="pt-12 hover:text-blue-600 cursor-pointer">About</li>
                    <li className="pt-12 hover:text-blue-600 cursor-pointer">Education</li>
                    <li className="pt-12 hover:text-blue-600 cursor-pointer">Projects</li>
                    <li className="pt-12 hover:text-blue-600 cursor-pointer">Let's talk</li>
                    <li className="flex justify-center gap-12 pt-12 pb-8 cursor-pointer">
